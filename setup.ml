...
(* OASIS_START *)
(* DO NOT EDIT (digest: 36094de0cdc4cd6e521aeb7abc0706a6) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "fold"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "¤ö\001\\§c\140=Q\128ToÁ-\157¬";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
