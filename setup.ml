...
(* OASIS_START *)
(* DO NOT EDIT (digest: de9bb35291a5b8133de2d3a813edb2c3) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/fold-lang/pratt-parser";
          synopsis =
            "Top down operator precedence parser (also known as Pratt parser).";
          description = None;
          categories = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/fold-lang/pratt-parser.git";
                      src_repo_browser =
                        Some "https://github.com/fold-lang/pratt-parser";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "UÀ\128Ö\149a\138\"\"\155Î\020MdL©";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
